...
/**
 * merge_sort_recursive - function to implement the merge sort algorithm through recursion.
 * @subarr: subarray of an array of integers to sort.
 * @buff: buf to store the sorted result.
...
/**
 * merge_sort - function to sort an array of integers in ascending
